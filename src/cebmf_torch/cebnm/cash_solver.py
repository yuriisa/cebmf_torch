...
class cash_PosteriorMeanNorm:
    """Result container for the CASH solver.

    Family-specific result types (LC-ASH, S-LC-ASH) subclass this base in
    their respective modules to add fields and methods they need without
    polluting the CASH base. See:

    * :class:`cebmf_torch.cebnm.lcash.lcash_PosteriorMeanNorm`
    * :class:`cebmf_torch.cebnm.s_lcash.slcash_PosteriorMeanNorm`
    """
